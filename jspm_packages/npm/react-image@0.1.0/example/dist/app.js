...
require = (function e(t, n, r) {
  ...
  return s;
    ...
    var ComponentPreview = React.createClass({
      ...
      propTypes: {code: React.PropTypes.string.isRequired},
    ...
    var CodeMirrorEditor = React.createClass({
      ...
      componentDidMount: function() {
        ...
        this.editor.on('beforeSelectionChange', function(instance, obj) {
          ...
          if (match && cursor.ch >= match.index && cursor.ch < match.index + 3) {
    ...
    var ReactPlayground = React.createClass({
      ...
      getInitialState: function() {
        return {code: this.props.codeText};
      },
      ...
      render: function() {
        ...
        })), React.createElement("div", {className: "playgroundPreview"}, React.createElement(ComponentPreview, {code: this.state.code})));
      }
    });
    React.render(React.createElement(ReactPlayground, {codeText: document.getElementById('code1').innerHTML}), document.getElementById('example1'));
    React.render(React.createElement(ReactPlayground, {codeText: document.getElementById('code2').innerHTML}), document.getElementById('example2'));
    React.render(React.createElement(ReactPlayground, {codeText: document.getElementById('code3').innerHTML}), document.getElementById('example3'));
  }, {
    "react": undefined,
    "react-image": undefined
  }]}, {}, [1]);
