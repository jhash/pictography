System.registerDynamic("npm:react-fastclick@1.0.3", ["npm:react-fastclick@1.0.3/index"], true, function(require, exports, module) {
  ;
  var global = this,
      __define = global.define;
  global.define = undefined;
  module.exports = require("npm:react-fastclick@1.0.3/index");
...
System.registerDynamic("npm:director@1.2.8", ["npm:director@1.2.8/build/director"], true, function(require, exports, module) {
  ;
  var global = this,
      __define = global.define;
  global.define = undefined;
...
System.registerDynamic("npm:react-fastclick@1.0.3/index", ["npm:react@0.13.3", "npm:react@0.13.3/lib/EventListener"], true, function(require, exports, module) {
  ;
  var global = this,
      __define = global.define;
  global.define = undefined;
    ...
    EventListener.listen = function(target, eventType, callback) {
      if (eventType === 'click') {
        ...
        var onTouchMove = function(event) {
          ...
          if (Math.abs(downPos.clientX - touch.clientX) >= constants.moveThreshold || Math.abs(downPos.clientY - touch.clientY) >= constants.moveThreshold) {
            moved = true;
          }
        };
...
System.register('lib/main.js', ['npm:react-fastclick@1.0.3', 'npm:director@1.2.8', 'npm:react@0.13.3', 'lib/home.jsx!npm:jspm-loader-jsx@0.0.7', 'lib/bootstrap.js', 'lib/events.js'], function (_export) {
  'use strict';

  var director, Router, React, HomePage, bootstrap, emitter, renderView, routes, router;
  return {
    setters: [function (_npmReactFastclick103) {}, function (_npmDirector128) {
      director = _npmDirector128.director;
      Router = _npmDirector128.Router;
    ...
    execute: function () {
      ...
      routes = {
        '': {
          on: renderView.bind(undefined, HomePage),
          '/:image': {
            on: function on(image) {
...
System.register('lib/home.jsx!npm:jspm-loader-jsx@0.0.7', ['npm:lodash@3.10.1', 'npm:react@0.13.3', 'lib/collage.jsx!npm:jspm-loader-jsx@0.0.7', 'lib/lightBox.jsx!npm:jspm-loader-jsx@0.0.7', 'lib/infiniteScroll.jsx!npm:jspm-loader-jsx@0.0.7', 'lib/events.js', 'lib/main.js', 'npm:font-awesome@4.4.0/css/font-awesome.css!github:systemjs/plugin-css@0.1.18'], function (_export) {
  'use strict';

  var _, React, Collage, LightBox, InfiniteScroll, emitter, router, imgs, HomePage;
  ...
  return {
    ...
    execute: function () {
      ...
      HomePage = React.createClass({
        ...
        findAndOpenImage: function findAndOpenImage(imageId) {
        ...
        render: function render() {
          return React.createElement(
            'div',
            { className: 'no-scrolling home-wrapper' },
            ...
            React.createElement(
              InfiniteScroll,
              { loadMore: this.loadMore, styles: this.state.infiniteScrollStyle },
    ...
    execute: function () {
      ...
      Image = React.createClass({
        ...
        render: function render() {
          ...
          var theWidths = (this.props.widths || []).sort(function (a, b) {
            return a > b;
          });
          return React.createElement(
            'picture',
            null,
            !this.state.sourceReset ? theWidths.map(function (width, index) {
              ...
              return React.createElement('source', { srcSet: fileName + width + fileType, media: index !== theWidths.length - 1 ? '(max-width: ' + width * (_this.props.widthMultiplier || 1) + 'px)' : null });
            }) : null,
            React.createElement('img', { ref: 'lazyLoadingImage', onError: this.imageError, onLoad: this.imageLoader, style: _Object$assign({}, this.props.styles), alt: this.props.alt, width: this.props.width, height: this.props.height })
          );
        }
      });
